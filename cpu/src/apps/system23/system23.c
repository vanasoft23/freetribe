...
static uint8_t g_sequencer_num_steps = 16;
static uint8_t g_selected_bar = 0;
static t_step g_sequencer_steps[64] = {
    { GATE_4TH , 61 + 0, false, false },
    { GATE_4TH , 61 + 0, false, false },
    { GATE_8TH , 61 + 7, false, true  },
    { GATE_4TH , 61 + 7, false, false },
    { GATE_8TH , 61 + 8, false, false },
    { GATE_4TH , 61 + 8, false, false },
    { GATE_4TH , 61 +12, false, false },
    { GATE_4TH , 61 +12, false, false },
    { GATE_4TH , 61 -12, false, false },
    { GATE_4TH , 61 -12, false, false },
    { GATE_4TH , 61 + 8, false, false },
    { GATE_4TH , 61 + 8, false, false },
    { GATE_4TH , 61 +20, false, false },
    { GATE_4TH , 61 +19, false, false },
    { GATE_8TH , 61 + 7, false, false },
    { GATE_4TH , 61 + 7, false, false },
};
