 ...
 * @file    handoff.c
 *
 * @brief   Methods for establishing compatible hardware state.
 * 
...
extern void boot_sanitize_and_jump(void) __attribute__((noreturn));
...
/**
 * @brief   Puts memory into a known hardware state.
 *
 * @details
 * First cleans and invalidates the D-cache.
 * Then zeroes the rest of 62 MiB of DDR (right above firmware image).
 * Finally, the instruction cache is invalidated.
 */
void boot_sanitize_ddr_and_caches(void) {
...
// // taken straight from SBL decompilation
// static void factory_sbl_aintc_channel_mappings() {

//     const u32 baseAddr = SOC_AINTC_0_REGS;

//     const u32 DAT_800023fc = 0xC3C00838;
//     for (int c = 0; c < 0x65; c = c + 1) {
//         HWREG(DAT_800023fc + c * 4) = 0;
//     }
//     HWREG(DAT_800023fc + 0xe8) = 3;
//     HWREG(DAT_800023fc + 0xd4) = 6;
//     HWREG(DAT_800023fc + 0x110) = 5;
//     HWREG(DAT_800023fc + 0x54) = 8;
//     HWREG(DAT_800023fc + 0x40) = 4;

//     HWREG(baseAddr + 0x400) = 0;
//     HWREG(baseAddr + 0x404) = 0;
//     HWREG(baseAddr + 0x408) = 0;
//     HWREG(baseAddr + 0x40c) = 0;
//     HWREG(baseAddr + 0x410) = 4;
//     HWREG(baseAddr + 0x414) = 0x800;
//     HWREG(baseAddr + 0x418) = 0;
//     HWREG(baseAddr + 0x41c) = 0;
//     HWREG(baseAddr + 0x420) = 0;
//     HWREG(baseAddr + 0x424) = 0;
//     HWREG(baseAddr + 0x428) = 0;
//     HWREG(baseAddr + 0x42c) = 0;
//     HWREG(baseAddr + 0x430) = 0;
//     HWREG(baseAddr + 0x434) = 0x600;
//     HWREG(baseAddr + 0x438) = 0x30000;
//     HWREG(baseAddr + 0x43c) = 0;
//     HWREG(baseAddr + 0x440) = 0;
//     HWREG(baseAddr + 0x444) = 5;
// }
