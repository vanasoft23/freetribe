...
static void _handle_off(void);
static void _handle_idle(void);
static void _handle_error(void);
static void _handle_host_write_header_config(void);
static void _handle_host_write_config(void);
static void _handle_host_write_done(void);
static void _handle_host_read_config(void);
static void _handle_host_read_done(void);
static void _handle_transfer_states(void);
...
// Bit helpers
static inline bool _allow_config(void);
static inline bool _is_dma_ready(void);
static inline bool _is_dma_complete(void);
static inline bool _dma_dir_bit(void);
static inline bool _is_fifo_full(void);
static inline bool _is_fifo_empty(void);
static inline bool _handshake_bit(void);
static inline bool _bus_timeout_enabled(void);
...
static inline bool _allow_config(void)        { return (*HDMA_CONFIG_PORT & HOST_STATUS_ALLOW_CNFG) != 0x0000; }
static inline bool _is_fifo_full(void)        { return (*HDMA_CONFIG_PORT & HOST_STATUS_FIFOFULL  ) != 0x0000; }
static inline bool _is_fifo_empty(void)       { return (*HDMA_CONFIG_PORT & HOST_STATUS_FIFOEMPTY ) != 0x0000; }
static inline bool _is_dma_ready(void)        { return (*HDMA_CONFIG_PORT & HOST_STATUS_DMA_RDY   ) != 0x0000; }
static inline bool _is_dma_complete(void)     { return (*HDMA_CONFIG_PORT & HOST_STATUS_DMA_CMPLT ) != 0x0000; }
static inline bool _dma_dir_bit(void)         { return (*HDMA_CONFIG_PORT & HOST_STATUS_DMA_DIR   ) != 0x0000; }
static inline bool _handshake_bit(void)       { return (*HDMA_CONFIG_PORT & HOST_STATUS_HSHK      ) != 0x0000; }
static inline bool _bus_timeout_enabled(void) { return (*HDMA_CONFIG_PORT & HOST_STATUS_BTE       ) != 0x0000; }
